...
export class DebitPaymentVoucherListComponent extends BaseComponent implements OnInit {
  ...
  gridColumns(): ColumnType[] {
    return [
      ...
      { field: "chequeDate", header: this.fieldTitle['chequeissuedate'], isDateFilter: true, dataList: this.modelSvc.gridChequeIssueDateList, labelField: 'ChequeDate' },
      { field: "clearedOnDate", header: this.fieldTitle['clearedondate'], isDateFilter: true, dataList: this.modelSvc.gridChequeClearedOnDateList, labelField: 'ClearedOnDate' },
