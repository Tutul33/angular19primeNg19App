    ...
    template: `
        ...
        <ng-template #builtInElement>
            <ng-container [ngSwitch]="type">
                ...
                <p-calendar appendTo="body" *ngSwitchCase="'date'" dateFormat="dd-M-y" (ngModelChange)="onModelChange($event)" [ngModel]="filterConstraint?.value"></p-calendar>
            </ng-container>
        </ng-template>
    `,
    encapsulation: ViewEncapsulation.None,
...
@Component({
    ...
    standalone:true,
    imports:[CommonModule,FormsModule,ButtonModule,DropdownModule,ColumnFilterFormElement],    
})
