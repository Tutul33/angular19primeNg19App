import { NgModule, Component, ElementRef, OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, OnDestroy, Input, Output, Renderer2, EventEmitter,
    forwardRef, ViewChild, ChangeDetectorRef, TemplateRef, ContentChildren, QueryList, ContentChild, ChangeDetectionStrategy, ViewEncapsulation, Optional } from '@angular/core';
import { trigger,style,transition,animate,AnimationEvent} from '@angular/animations';
import { CommonModule } from '@angular/common';
import { DomHandler, ConnectedOverlayScrollHandler } from 'primeng/dom';
import { ObjectUtils, ZIndexUtils } from 'primeng/utils';
import { PrimeNG } from 'primeng/config';
import { SharedModule, PrimeTemplate, Footer, Header, FilterService, TranslationKeys, OverlayService } from 'primeng/api';
...
@Component({
    ...
    imports:[CommonModule,TooltipModule,MultiSelectItem,ScrollingModule]
})
...
export class MultiSelect implements OnInit,AfterViewInit,AfterContentInit,AfterViewChecked,OnDestroy,ControlValueAccessor {
    ...
    constructor(public el: ElementRef, public renderer: Renderer2, public cd: ChangeDetectorRef, public filterService: FilterService, public config: PrimeNG, public overlayService: OverlayService,
        ) {}
...
@NgModule({
    imports: [CommonModule,SharedModule,ScrollingModule,TooltipModule,RippleModule,MultiSelect,MultiSelectItem],
